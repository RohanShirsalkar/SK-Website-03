...
const InfoCardImgRight = ({
  ...
  return (
    <div className="bg-white border border-blue-300 rounded-lg p-2 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-2 lg:gap-8">
...
export default InfoCardImgRight;
