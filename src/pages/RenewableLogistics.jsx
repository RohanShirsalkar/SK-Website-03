...
const RenewableLogistics = () => {
  return (
    <div className="">
      <Banner
        heading={"Renewable Logistics"}
      ...
      <div className="max-w-7xl mx-auto py-8 space-y-14 px-2">
        ...
        <InfoCardImgRight
          ...
          heading={"Redefining Wind Energy Fleet Transportation"}
          descriptions={[
            ` We elevate wind turbine logistics with a specialized fleet of advanced trailers and adapters, designed to transport massive wind components across the most challenging landscapes. Equipped with precision-engineered tower and blade adapters and schnable trailer, our solutions ensure the safe, steady transit of each component—from blades to towers—overcoming every obstacle seamlessly from origin to destination. Featuring nacelle and hub trailers, alongside blade and tower quad and penta axle trailers, our purpose-built vehicles are engineered to tackle complex routes, delivering controlled maneuverability even through tight and demanding spaces.`,
          ]}
        />
        <InfoCardImgLeft
          imagePath={"/renewable_01.webp"}
...
export default RenewableLogistics;
